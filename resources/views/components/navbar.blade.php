            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-2">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end animate slideIn shadow border-0 mt-2">
                        <li>
                            <a class="dropdown-item py-2 d-flex align-items-center" href="{{ route('api.points') }}" target="_blank">
                        ...
                        <li>
                            <a class="dropdown-item py-2 d-flex align-items-center" href="{{ route('api.polylines') }}" target="_blank">
                        ...
                        <li><hr class="dropdown-divider mx-2"></li>
                        <li>
                            <a class="dropdown-item py-2 d-flex align-items-center" href="{{ route('api.polygons') }}" target="_blank">
